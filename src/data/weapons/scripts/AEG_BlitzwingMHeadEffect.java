...
public class AEG_BlitzwingMHeadEffect implements EveryFrameWeaponEffectPlugin {
    private static final int MAX_FRAMES = 7;
    private static final float FRAME_DURATION = 0.142857f; // Duration of each frame in seconds (1 second / 7 frames)
