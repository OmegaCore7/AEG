...
public class AEG_4g_rightimpact implements BeamEffectPlugin {

    private IntervalUtil fireInterval = new IntervalUtil(0.05f, 0.05f);
    private final Vector2f ZERO = new Vector2f();
    private final float BLADE_KNOCKBACK_MAX = 50f;
    private static final Color PARTICLE_COLOR = new Color(255,255,0,255);
